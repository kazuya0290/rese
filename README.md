...
・<strong>管理者画面(新店舗追加の為のCSVファイル記入例)</strong>：新店舗追加のために、[新店舗追加ファイル.csv](https://github.com/user-attachments/files/18096847/default.csv)(src > public)に店舗名、地域、ジャンル、店舗概要、画像URLをそれぞれ入力し、csvファイルを選択してインポートボタンをクリックすることで新店舗情報を追加することが出来ます。
