...
・<strong>管理者画面(利用者(ユーザー)の全店舗の口コミ確認・削除とCSVファイルインポート機能)</strong>：利用者（ユーザー）の全店舗の口コミ確認・削除とCSVファイルインポート機能を実装しました。「全店舗の口コミを表示」ボタンをクリックすると、モーダルウィンドウが表示され、全店舗の口コミを確認することができ、口コミの削除も行うことができます。インポートボタンでは、[新店舗追加ファイル.csv](https://github.com/user-attachments/files/18096847/default.csv)に入力されたデータをインポートすることで、新しい店舗情報を追加することが可能です。<br>
