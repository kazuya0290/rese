...
<strong>レビュー内容確認・編集・削除画面</strong>
...
・<strong>店舗詳細画面</strong>：店舗の画像、エリア・ジャンルのハッシュタグ、店舗の詳細な説明が記載されてあります。「<」をクリックすると一覧に戻り、「画像を保存する」ボタンをクリックするとストレージに画像を保存することが可能で、非ログイン時でも画像の保存が可能です。右側の予約フォームは非ログイン時には利用することが出来ませんが、ログイン時には上から順に日付、時間、人数をそれぞれ選択することで予約を行うことが可能です。また、予約方法は通常予約とStripe決済での予約を選ぶことが出来ます。<br>
