...
・<strong>口コミ投稿画面</strong>：各店舗の５段階評価、コメントを記入することが可能です。５段階評価はカーソルを星に合わせてクリックすることで評価することが可能となっております。また、画像の投稿も可能(必須)となっており、「クリックして画像を追加またはドラッグアンドドロップ」エリアをクリックするかエリア内に画像を直接ドラッグアンドドロップすることで画像を挿入することが可能となります。<br>

・<strong>口コミ投稿バリデーション</strong>：口コミの記載は1人のユーザーが2件以上の口コミを記載することが出来ない仕組みとなっております。ご了承ください。<br>
