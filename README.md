...
Rese飲食店予約サービスアプリは、利用者(ユーザー)が飲食店をエリアやジャンルごとに簡単に検索し、オンラインで予約できるサービスです。<br>
お気に入り店舗の追加や予約の管理、QRコード発行機能、オンライン決済（Stripe決済）やリマインダーメール機能、レビュー投稿機能など、ユーザーが快適に利用できる多彩な機能を提供しています。<br>  
さらに、店舗代表者や管理者は、店舗情報の更新や新規追加が可能で、店舗の運営をスムーズにサポートします。<br> 
...
・<strong>メニュー画面2(ログイン時)</strong>：非ログイン時と少し変わり、Homeはクリックすると非ログイン時と同じくホーム画面が表示され、Logoutボタンをクリックするとログアウト確認のアラートメッセージが表示され、OKをクリックするとログアウト状態となり、Mypageをクリックするとマイページ画面が表示されます。<br>
